...
namespace PPD.AuthenticationCenter.Configuration
{
    internal sealed class FileMonitor
    {
        ...
        //public void DefaultCacheRemovedCallback(string key, object value, CacheItemRemovedReason reason)
        //{
        //    System.IO.File.AppendAllText("D:/logs.log", key + " " + value.ToString());
        //}
    }
}
