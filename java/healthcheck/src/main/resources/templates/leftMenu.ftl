<div class="aside">
    ...
    <div class="aside_main">
        <dl class="aside_dl">
            ...
            <dd class="aside_dd"><a href="/healthcheck/serverHealthCheckConfig" class="aside_nav <#if menuKey==2>active</#if>"><i class="icon icon_nav_ux fas fa-cog"></i>应用设置</a></dd>
            <dd class="aside_dd"><a href="/healthcheck/springbootActuatorLogSetting" class="aside_nav <#if menuKey==3>active</#if>"><i class="icon icon_nav_ux fas fa-archive"></i>SpringBoot日志</a></dd>
        </dl>
        <dl class="aside_dl">
